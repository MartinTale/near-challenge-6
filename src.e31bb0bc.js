...
const CONTRACT_NAME = undefined || 'stress.testnet';
...
document.getElementById('claim').onclick = async () => {
  ...
  }, BOATLOAD_OF_GAS, (0, _big.default)('0.00125').times(10 ** 24).toFixed());
};
...
document.getElementById('send').onclick = async () => {
  ...
  }, BOATLOAD_OF_GAS, (0, _big.default)('0.000000000000000000000001').times(10 ** 24).toFixed());
  window.location.reload();
